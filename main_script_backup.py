    ...
    def RunGeneticAlgorithm(ExperimentNumberID, BC, MAT, CONSTRAINTS):
        ...
        #         
                ...
                if TerminationCondition == True:
                    ...
                    """
                    Step 3. Select the Parents for Crossover
                    """
                    ...
                    PopulationComposition['Gen '+str(Generation)][6] = PopulationCurrentSelected
                    ...
                    if BC.Crossover[0] == str(True):
                        ...
                        while PopulationOffspring.tail(1).Chromosome[BC.N_pop[0]] is None: #keep recombining until the entire PopulationOffspring is filled with solutions
                            ...
                            for Child in range(0,len(Children)):
                                PopulationComposition['Gen '+str(Generation+1)][0] = genetic_algorithm.Population.StorePopulationData(PopulationDataframe = PopulationComposition['Gen '+str(Generation+1)][0], Operation = "Crossover", Chromosome = Children[Child] , Fitness = 0, Pp = None, Parents = [PopulationParents.Chromosome[ParentSelected1],PopulationParents.Chromosome[ParentSelected2]],FatigueCalculations = 0,ExperimentNumberID = ExperimentNumberID)
        ...
        topPatterns = visuals.FatigueVisuals.ShowTop3CrenellationPatterns(PopulationFinal, PopulationInitial, ExperimentNumberID)
